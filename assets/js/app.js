(() => {
  ...
  function mediaPostCard(post, type) {
    return `<article class="media-post-card reveal">
      ...
      <div class="media-post-footer">
        ...
        <a href="${post.url}" target="_blank" rel="noopener noreferrer">View on LinkedIn ${icons.external}</a>
      </div>
    </article>`;
  }
      ...
      <section class="section container media-section">
        ...
        <div class="media-group">
          ...
          <div class="media-post-grid">
            ${media.ownPosts.map((post) => mediaPostCard(post, "My post")).join("")}
          </div>
        </div>
        ...
        <div class="media-group">
          ...
          <div class="media-post-grid">
            ${media.featuredPosts.map((post) => mediaPostCard(post, "Featured post")).join("")}
          </div>
        </div>
      </section>
